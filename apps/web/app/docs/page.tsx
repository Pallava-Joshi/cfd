      ...
      <div className="container mx-auto px-4 py-16 pt-24">
        <div className="max-w-5xl mx-auto">
          <div className="text-center my-20">
            <h1 className="font-cal-sand text-4xl md:text-6xl font-medium text-black leading-tight mb-6 tracking-tight">
              MarginX{" "}
              <span className="italic font-instrument-serif tracking-normal">
                Documentation
              </span>
            </h1>
            <p className="text-sm md:text-base text-black mb-8 max-w-2xl mx-auto leading-relaxed font-ibm-plex-mono">
          ...
          <div
            className="border border-[var(--border)] mb-16 rounded-xl overflow-hidden"
            style={{ backgroundColor: "#FFF" }}
          >
            <div className="border-b border-[var(--border)] px-8 py-6">
              <h2 className="font-cal-sand text-2xl font-semibold text-black tracking-tight">
                System Architecture
              </h2>
            </div>
            <div className="p-8">
              <div className="text-center mb-8">
                <img
                  ...
                  alt="MarginX System Architecture"
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-3 text-sm text-gray-700 leading-relaxed">
                      ...
                      <div className="bg-gray-50 p-4 font-ibm-plex-mono text-xs">
                        <div>
                          • Take Profit: long orders when price ≥ target, short
                          orders when price ≤ target
                        </div>
                        <div>
                          • Stop Loss: long orders when price ≤ target, short
                          orders when price ≥ target
                        </div>
                        <div>
  ...
  id: 1
                  ...
                  <div>
                    ...
                    <div className="space-y-3 text-sm text-gray-700 leading-relaxed">
                      ...
                      <div className="bg-gray-50 p-4 font-ibm-plex-mono text-xs">
                        <div>
                          • Bid price: Used for long order executions (closing)
                          and short order entries
                        </div>
                        <div>
                          • Ask price: Used for short order executions (closing)
                          and long order entries
                        </div>
                ...
                <div className="space-y-6">
                  <div className="border border-gray-200 p-6">
                    ...
                    <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
                      <p>
                        The system implements an asynchronous request-response
                        pattern using Redis streams as a message bus and an
                        in-memory callback registry. This enables non-blocking
                        communication between the API service and the trading
                        engine while maintaining request-response semantics.
                      </p>
...
const result = await sendRequestAndWait(orderId, {
  ...
  payload
                      ...
                      <p className="pt-2">
                        The{" "}
                        <span className="font-ibm-plex-mono text-xs bg-gray-100 px-1">
                          sendRequestAndWait
                        </span>{" "}
                        function orchestrates two parallel operations:
                      </p>
                      ...
                      <div className="bg-gray-50 p-4 border-l-4 border-gray-300">
                        ...
                        <div className="space-y-2 font-ibm-plex-mono text-xs">
                          <div>
                            ...
                            addToStream(id, request) → XADD to engine-stream
                          </div>
                          <div>
                            • <span className="font-semibold">Waiting:</span>{" "}
                            subscriber.waitForMessage(id) → Promise with 5s
                            timeout
                          </div>
                        </div>
                      </div>
  ...
  await redis.xadd(
    ...
    "request", JSON.stringify(request)
                        ...
                        <div className="bg-gray-50 p-3 space-y-1 font-ibm-plex-mono text-xs">
                          <div>
                            • <span className="font-semibold">id:</span> Unique
                            correlation ID
                          </div>
                          <div>
                            • <span className="font-semibold">request:</span>{" "}
                            JSON payload with kind and data
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    setTimeout(() => {
      if (this.callbacks[id]) {
        ...
        reject(new Error("Timeout"));
                        ...
                        <p>
                          The callback is stored in an in-memory map keyed by
                          the correlation ID, with automatic cleanup on timeout.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border border-gray-200 p-6">
                    ...
                    <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
                      <p>
                        The engine service runs a continuous loop that consumes
    ...
    for (const [id, data] of entries) {
      ...
      lastId = id;
                  ...
                  <div className="border border-gray-200 p-6">
                    ...
                    <div className="space-y-4 text-sm text-gray-700 leading-relaxed">
                      <p>
                        A separate subscriber loop continuously listens for
                        callbacks:
                      </p>
                      <div className="bg-black text-white p-4 font-ibm-plex-mono text-xs overflow-x-auto">
                        {`async runLoop() {
      ...
      for (const [messageId, data] of messages) {
        ...
        if (callbackId && this.callbacks[callbackId]) {
          ...
          delete this.callbacks[callbackId];
                      ...
                      <p className="pt-2">
                        When a callback arrives, the subscriber immediately
                        resolves the corresponding Promise, unblocking the
                        original API request and allowing it to return the
                  ...
                  <div className="bg-gray-50 border border-gray-300 p-6">
                    ...
                    <div className="space-y-2 text-sm text-gray-700">
                      <div className="flex items-start">
                        <span className="font-ibm-plex-mono text-xs bg-white px-2 py-1 rounded mr-3 font-semibold">
                          1
                        </span>
                        <span>
                          Trade controller calls{" "}
                          <code className="font-ibm-plex-mono text-xs bg-white px-1">
                            createOrder
                          </code>
                          , generates unique ID, builds payload
                        </span>
                      </div>
                      <div className="flex items-start">
                        <span className="font-ibm-plex-mono text-xs bg-white px-2 py-1 rounded mr-3 font-semibold">
                        ...
                        <span>
                          Calls{" "}
                          <code className="font-ibm-plex-mono text-xs bg-white px-1">
                            sendRequestAndWait(id, payload)
                          </code>{" "}
                          which executes both operations in parallel
                        </span>
                      </div>
                      <div className="flex items-start">
                        <span className="font-ibm-plex-mono text-xs bg-white px-2 py-1 rounded mr-3 font-semibold">
                        ...
                        <span>
                          ...
                          publishes message to engine-stream via XADD
                        </span>
                      </div>
                      <div className="flex items-start">
                        <span className="font-ibm-plex-mono text-xs bg-white px-2 py-1 rounded mr-3 font-semibold">
                        ...
                        <span>
                          ...
                          creates Promise, registers callback in memory map with
                          5s timeout
                        </span>
                      </div>
                      <div className="flex items-start">
                        ...
                        <span>
                          Engine consumes message from engine-stream, processes
                          order (validate, execute, store)
                        </span>
                      </div>
                      <div className="flex items-start">
                        <span className="font-ibm-plex-mono text-xs bg-white px-2 py-1 rounded mr-3 font-semibold">
                        ...
                        <span>
                          Engine publishes callback to callback-queue via XADD
                          with original correlation ID and status
                        </span>
                      </div>
                      <div className="flex items-start">
                        <span className="font-ibm-plex-mono text-xs bg-white px-2 py-1 rounded mr-3 font-semibold">
                        ...
                        <span>
                          ...
                          receives callback, extracts ID, finds matching
                          callback in map
                        </span>
                      </div>
                      <div className="flex items-start">
                        ...
                        <span>
                          ...
                          to resolve Promise, deletes callback from map
                        </span>
                      </div>
                      <div className="flex items-start">
                        <span className="font-ibm-plex-mono text-xs bg-white px-2 py-1 rounded mr-3 font-semibold">
                        ...
                        <span>
                          API request unblocks, returns response to client
                        </span>
                      </div>
                    </div>
                  </div>
...
const remainingMargin = initialMargin + currentPnl;`}
          ...
          >
            <div className="border-b border-[var(--border)] px-8 py-6">
              <h2 className="font-cal-sand text-2xl font-semibold text-black tracking-tighter">
                Docker Setup
              </h2>
            </div>
            <div className="p-8">
  ...
  postgres:
    ...
    volumes:
      - postgres_data:/var/lib/postgresql/data`}
          ...
          <div className="text-center">
            <div
              className="border border-[var(--border)] p-12 rounded-xl"
              style={{ backgroundColor: "#FFF" }}
            >
              <h2 className="font-cal-sand text-3xl font-medium text-black mb-6">
                Ready to get{" "}
                <span className="italic font-instrument-serif tracking-normal">
                  started
                </span>
              ...
              <p className="text-sm md:text-base text-black mb-8 max-w-2xl mx-auto leading-relaxed font-ibm-plex-mono">
                ...
                MarginX. Join the world of limitless trading opportunities.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
                <Link href="/marketplace">
                  <Button
                    size="default"
                    className="text-[15px] px-8 py-2.5 rounded-2xl"
                  >
                    Try the Platform
                  </Button>
                </Link>
